...
* Rolling Windows using rangestat
...
* Rolling Beta Panel - with crisis zones:

twoway ///
(rarea ylowport yhighport Date if inrange(Date, tm(1995m1), tm(2001m1)), color(gs13)) ///
(rarea ylowport yhighport Date if inrange(Date, tm(2007m6), tm(2009m2)), color(gs13)) ///
(rarea ylowport yhighport Date if inrange(Date, tm(2020m1), tm(2020m9)), color(gs13)) ///
(line beta_portfolio_12m Date if reg_nobs_portfolio_12m==12, lcolor(gold)) ///
(line beta_portfolio_60m Date if reg_nobs_portfolio_60m==60, lcolor(red)) ///
(line beta_portfolio_120m Date if reg_nobs_portfolio_120m==120, lcolor(blue)), ///
title("Portfolio Rolling Betas") name(beta1, replace) ytitle("Beta") xtitle("Date") ///
ytitle("Beta", axis(1)) ///
xtitle("Date", margin(small)) ///
legend(order(4 "12M" 5 "60M" 6 "120M") rows(1)) ///
xlabel(`=tm(1995m2)' `=tm(2000m2)' `=tm(2005m2)' `=tm(2010m2)' `=tm(2015m2)' `=tm(2020m2)' `=tm(2025m2)', ///
format(%tmCY) labsize(small) angle(0) grid glcolor(gs14)) ///
scheme(s1color)


twoway ///
(rarea ylowtrcc yhightrcc Date if inrange(Date, tm(1995m1), tm(2001m1)), color(gs13)) ///
(rarea ylowtrcc yhightrcc Date if inrange(Date, tm(2007m6), tm(2009m2)), color(gs13)) ///
(rarea ylowtrcc yhightrcc Date if inrange(Date, tm(2020m1), tm(2020m9)), color(gs13)) ///
(line beta_trcc_12m Date if reg_nobs_trcc_12m==12, lcolor(gold) lpattern(solid)) ///
(line beta_trcc_60m Date if reg_nobs_trcc_60m==60, lcolor(red) lpattern(solid)) ///
(line beta_trcc_120m Date if reg_nobs_trcc_120m==120, lcolor(blue) lpattern(solid)), ///
title("TRCC Rolling Betas") name(beta2, replace) ytitle("Beta") xtitle("Date") ///
ytitle("Beta", axis(1)) ///
xtitle("Date", margin(small)) ///
legend(order(4 "12M" 5 "60M" 6 "120M") rows(1)) ///
xlabel(`=tm(1995m2)' `=tm(2000m2)' `=tm(2005m2)' `=tm(2010m2)' `=tm(2015m2)' `=tm(2020m2)' `=tm(2025m2)', ///
...
twoway ///
(rarea ylowbcom yhighbcom Date if inrange(Date, tm(1995m1), tm(2001m1)), color(gs13)) ///
(rarea ylowbcom yhighbcom Date if inrange(Date, tm(2007m6), tm(2009m2)), color(gs13)) ///
(rarea ylowbcom yhighbcom Date if inrange(Date, tm(2020m1), tm(2020m9)), color(gs13)) ///
(line beta_bcom_12m Date if reg_nobs_bcom_12m==12, lcolor(gold) lpattern(solid)) ///
(line beta_bcom_60m Date if reg_nobs_bcom_60m==60, lcolor(red) lpattern(solid)) ///
(line beta_bcom_120m Date if reg_nobs_bcom_120m==120, lcolor(blue) lpattern(solid)), ///
title("BCOM Rolling Betas") name(beta3, replace) ytitle("Beta") xtitle("Date") ///
ytitle("Beta", axis(1)) ///
xtitle("Date", margin(small)) ///
legend(order(4 "12M" 5 "60M" 6 "120M") rows(1)) ///
xlabel(`=tm(1995m2)' `=tm(2000m2)' `=tm(2005m2)' `=tm(2010m2)' `=tm(2015m2)' `=tm(2020m2)' `=tm(2025m2)', ///
...
title("Rolling Betas Across Horizons") col(3) iscale(0.8) xsize(9) ysize(3) ///
scheme(s1color)
...
* Rolling Correlation Panel - with crisis zones

twoway ///
(rarea ylowport yhighport Date if inrange(Date, tm(1995m1), tm(2001m1)), color(gs13)) ///
(rarea ylowport yhighport Date if inrange(Date, tm(2007m6), tm(2009m2)), color(gs13)) ///
(rarea ylowport yhighport Date if inrange(Date, tm(2020m1), tm(2020m9)), color(gs13)) ///
(line corr_portfolio_sp500_12m Date if portfolio_sp500_nobs_12m==12, yaxis(2) lcolor(gold) lpattern(solid)) ///
(line corr_portfolio_sp500_60m Date if portfolio_sp500_nobs_60m==60, yaxis(2) lcolor(red) lpattern(solid)) ///
(line corr_portfolio_sp500_120m Date if portfolio_sp500_nobs_120m==120, yaxis(2) lcolor(blue) lpattern(solid)), ///
title("Portfolio Rolling Correlation") name(correlation1, replace) ytitle("Correlation") xtitle("Date") ///
ytitle("Correlation", axis(1)) ///
xtitle("Date", margin(small)) ///
legend(order(4 "12M" 5 "60M" 6 "120M") rows(1)) ///
xlabel(`=tm(1995m2)' `=tm(2000m2)' `=tm(2005m2)' `=tm(2010m2)' `=tm(2015m2)' `=tm(2020m2)' `=tm(2025m2)', ///
format(%tmCY) labsize(small) angle(0) grid glcolor(gs14)) ///
...
(rarea ylowtrcc yhightrcc Date if inrange(Date, tm(2007m6), tm(2009m2)), color(gs13)) ///
(rarea ylowtrcc yhightrcc Date if inrange(Date, tm(2020m1), tm(2020m9)), color(gs13)) ///
(line corr_trcc_sp500_12m Date if trcc_sp500_nobs_12m==12, yaxis(2) lcolor(gold) lpattern(solid)) ///
(line corr_trcc_sp500_60m Date if trcc_sp500_nobs_60m==60, yaxis(2) lcolor(red) lpattern(solid)) ///
(line corr_trcc_sp500_120m Date if trcc_sp500_nobs_120m==120, yaxis(2) lcolor(blue) lpattern(solid)), ///
title("TRCC Rolling Correlation") name(correlation2, replace) ytitle("Correlation") xtitle("Date") ///
ytitle("Correlation", axis(1)) ///
xtitle("Date", margin(small)) ///
legend(order(4 "12M" 5 "60M" 6 "120M") rows(1)) ///
xlabel(`=tm(1995m2)' `=tm(2000m2)' `=tm(2005m2)' `=tm(2010m2)' `=tm(2015m2)' `=tm(2020m2)' `=tm(2025m2)', ///
...
(rarea ylowbcom yhighbcom Date if inrange(Date, tm(2007m6), tm(2009m2)), color(gs13)) ///
(rarea ylowbcom yhighbcom Date if inrange(Date, tm(2020m1), tm(2020m9)), color(gs13)) ///
(line corr_bcom_sp500_12m Date if bcom_sp500_nobs_12m==12, yaxis(2) lcolor(gold) lpattern(solid)) ///
(line corr_bcom_sp500_60m Date if bcom_sp500_nobs_60m==60, yaxis(2) lcolor(red) lpattern(solid)) ///
(line corr_bcom_sp500_120m Date if bcom_sp500_nobs_120m==120, yaxis(2) lcolor(blue) lpattern(solid)), ///
title("BCOM Rolling Correlation") name(correlation3, replace) ytitle("Correlation") xtitle("Date") ///
ytitle("Correlation", axis(1)) ///
xtitle("Date", margin(small)) ///
legend(order(4 "12M" 5 "60M" 6 "120M") rows(1)) ///
xlabel(`=tm(1995m2)' `=tm(2000m2)' `=tm(2005m2)' `=tm(2010m2)' `=tm(2015m2)' `=tm(2020m2)' `=tm(2025m2)', ///
...
twoway ///
(line VIX Date if Date >= tm(1990m1), yaxis(1) lcolor(blue) lwidth(medium)) ///
(line portfolio_close Date if Date >= tm(1990m1), yaxis(2) lcolor(gold) lwidth(medium)), ///
title("The Link Between the S&P 500 and the VIX") ///
ylabel(10(10)70, axis(1) angle(horizontal) labcolor(blue)) ///
ylabel(0(300)1800, axis(2) angle(horizontal) labcolor(gold)) ///
ytitle("VIX Index (LHS)", axis(1)) ///
...
twoway ///
(line VIX Date if Date >= tm(1990m1), yaxis(1) lcolor(blue) lwidth(medium)) ///
(line trcc_close Date if Date >= tm(1990m1), yaxis(2) lcolor(green) lwidth(medium)), ///
title("The Link Between the TRCC Index and the VIX") ///
ylabel(10(10)70, axis(1) angle(horizontal) labcolor(blue)) ///
ylabel(100(100)500, axis(2) angle(horizontal) labcolor(green)) ///
ytitle("VIX Index (LHS)", axis(1)) ///
...
twoway ///
(line VIX Date if Date >= tm(1990m1), yaxis(1) lcolor(blue) lwidth(medium)) ///
(line bcom_close Date if Date >= tm(1990m1), yaxis(2) lcolor(brown) lwidth(medium)), ///
title("The Link Between the BCOM Index and the VIX") ///
ylabel(10(10)70, axis(1) angle(horizontal) labcolor(blue)) ///
ylabel(50(50)250, axis(2) angle(horizontal) labcolor(brown)) ///
ytitle("VIX Index (LHS)", axis(1)) ///
